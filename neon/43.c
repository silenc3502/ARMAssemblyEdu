...
int main(void)
{
	int16_t in1[4] = {1, 2, 3, 4};
	int16_t in2[4] = {5, 6, 7, 8};
	int16_t in3[4] = {9, 10, 11, 12};
	int16x4_t a, b, v, r;
	int32x4_t r2;
	int16_t c = 2;
	...
	b = vld1_s16(&in2[0]);
	r = vmul_n_s16(a, c);
	print_s16x4_vectors(r);

	r2 = vmull_lane_s16(a, b, 2);
	print_s32_vectors(r2);

	v = vld1_s16(&in3[0]);
	r = vmla_n_s16(a, b, 2);
	print_s16x4_vectors(r);

	r = vmla_lane_s16(a, b, v, 2);
	print_s16x4_vectors(r);
